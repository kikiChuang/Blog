	...
	function submitData() {
		...
		if(title==null || title=='') {
			...
			$.post("${pageContext.request.contextPath}/admin/blog/save.do",{"title":title,"blogType.id":blogTypeId,
				"contentNoTag":UE.getEditor('content').getContentTxt(),"content":content,
				"summary":UE.getEditor('content').getContentTxt().substr(0,155),"keyWord":keyWord},function(result){
				if(result.success) {
					alert("博客发布成功！");
					resetData();
				} else {
...
<div id="p" class="easyui-panel" title="编写博客" style="padding: 10px;">
	<table cellspacing="20px">
		...
		<tr>
			...
			<td>
				<script type="text/plain" id="content" name="content" style="width:1000px;height:500px;"></script>
			</td>
		</tr>
		<tr>
			<td>关键字：</td>
