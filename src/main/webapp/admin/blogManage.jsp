...
<script type="text/javascript">
	function formatTitle(val,row) {
		return "<a href='${pageContext.request.contextPath}/blog/detail/"+row.id+".html' target='_blank'>"+val+"</a>";
	}
	...
	function deleteBlog() {
		...
		$.messager.confirm("系统提示","您确定要删除这<font color='red'>"+selectedRows.length+"</font>条博客吗？", function(r){
			if(r) {
				$.post("${pageContext.request.contextPath}/admin/blog/delete.do",{"idStr":idStr},function(result){
					if(result.success) {
...
<table id="dg" title="博客管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath }/admin/blog/list.do" fit="true" toolbar="#tb">
	<thead>
		<tr>
